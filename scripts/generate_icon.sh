...
DEFAULT_ICON_PROMPT="A macOS application icon: full-bleed square artwork that completely fills the entire 1024x1024 canvas edge to edge. The background itself is the design and must reach every edge of the frame — do NOT draw a rounded-square badge or rounded shape floating on a white or transparent backdrop, since macOS already applies the rounded-corner mask on top of this square afterward. Fill the whole square, corner to corner, with a smooth soft gradient background transitioning from sky blue #0EA5E9 to violet purple #8B5CF6. Centered in the composition: a friendly, modern, flat-design SLOTH paw — a furry rounded limb ending in exactly THREE long, curved, prominent claws. This is a sloth paw, not a cat or dog paw: it must have NO round toe-bean pads whatsoever; the three long gently-curved claws are the only and unmistakable identifying feature. Keep the claws smooth and soft-edged, cute and rounded rather than sharp or scary — think a friendly hooked curve with a rounded tip, not a talon. Render the furry paw in a warm tan/cream flat color, with the three claws in a slightly darker cream/tan tone, gentle minimal shading and a subtle soft drop shadow for depth. Integrated with the claws, a small, simple, minimal white or very light mouse-cursor arrow shape nestles between or under the claws, as if one curved claw is gently hooking the cursor. Crisp vector flat-illustration style, clean bold shapes, contemporary professional app-icon aesthetic, centered composition, balanced negative space. Use only this blue/purple palette (sky blue #0EA5E9, violet #8B5CF6, light tints #7DD3FC / #C4B5FD) plus the tan/cream paw color — no green and no orange anywhere in the image. Absolutely no text, no letters, no words, no numbers, no watermark, no signature anywhere in the image."

DEFAULT_BANNER_PROMPT="A wide hero banner image for a macOS menu bar app called Pawvis, horizontal composition on a 1536x1024 canvas, background filled edge to edge with a smooth soft gradient from sky blue #0EA5E9 to violet purple #8B5CF6. On the left side: a friendly, modern, flat-design SLOTH paw — a furry rounded limb ending in exactly THREE long, curved, prominent claws. This is a sloth paw, not a cat or dog paw: it must have NO round toe-bean pads whatsoever; the three long gently-curved claws are the only and unmistakable identifying feature. Keep the claws smooth, soft-edged, cute and rounded rather than sharp or scary. Render the furry paw in a warm tan/cream flat color with the three claws in a slightly darker cream/tan tone. A small simple white or very light mouse-cursor arrow shape nestles between or under the claws, as if one claw is gently hooking the cursor — crisp vector flat-illustration style with a subtle soft drop shadow, matching a polished macOS app-icon aesthetic. To the right of the paw icon: large, clean, modern bold sans-serif wordmark text reading exactly \"Pawvis\" in light cream or white lettering, simple and legible, correctly spelled P-A-W-V-I-S, with no other text, taglines, or extra characters anywhere in the image. Use only this blue/purple palette (sky blue #0EA5E9, violet #8B5CF6, light tints #7DD3FC / #C4B5FD) plus the tan/cream paw color — no green and no orange anywhere in the image. Minimal, professional software-branding banner, generous margins, balanced composition."
